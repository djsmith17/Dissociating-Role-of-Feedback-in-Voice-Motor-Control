function StatsOrg_DRF_Som_Aud_RMANOVA(dirs, StatTableSomVF, StatTableSomMN, StatTableAud)
...
% Right now only considering Response Percentage
...
condTable       = table({'SomVF' 'SomMN', 'Aud'}','VariableNames',{'Conditions'});

% Create a model in order to test for sphericity
measFit = fitrm(measTable, 'SomVF-Aud~1', 'WithinDesign', condTable, 'WithinModel', 'separatemeans');
