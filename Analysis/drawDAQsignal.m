...
for ii = 1:r
    ...
    t = annotation('textbox',[0.50 0.82 0.40 0.1],...
                   'string', {['Pressure Onset Lag: ' num2str(1000*niAn.PresLags(ii,1)) 'ms'];...
                              ['Onset & Offset Pressure Values: ' num2str(niAn.rangePressures(ii,1)) 'psi, ' num2str(niAn.rangePressures(ii,2)) 'psi']},...
                    'LineStyle','none',...
                    'FontWeight','bold',...
                    'FontSize',10,...
                    'FontName','Arial');
