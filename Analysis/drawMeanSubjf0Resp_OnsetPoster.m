...
xlabel('Time (s)', 'FontName', fontN, 'FontSize', axisLabelSize, 'FontWeight', 'bold'); 
ylabel(ax1, '{\it f}_o (cents)', 'FontName', fontN, 'FontSize', axisLabelSize, 'FontWeight', 'bold')
axis(limits); box off

set(gca,'FontName', fontN,...
        'FontSize', axesTextSize,...
        'FontWeight','bold',...
        'LineWidth', 2)
