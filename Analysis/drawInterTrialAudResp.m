...
axes(ha(1))
errorbar(time, meanTrialf0_St(:,1), meanTrialf0_St(:,2), 'blue', 'LineWidth',2) %Pertrubed Microphone
hold on
errorbar(time, meanTrialf0_St(:,3), meanTrialf0_St(:,4), 'black', 'LineWidth',2) %Perturbed Headphones
hold on
...
axes(ha(2))
errorbar(time, meanTrialf0_Sp(:,1), meanTrialf0_Sp(:,2), 'blue', 'LineWidth',2)  %Pertrubed Microphone
hold on
errorbar(time, meanTrialf0_Sp(:,3), meanTrialf0_Sp(:,4), 'black', 'LineWidth',2) %Perturbed Headphones
hold on
plot(dottedStartx, dottedy,'k','LineWidth',4)
xlabel('Time (s)', 'FontSize', 18, 'FontWeight', 'bold'); ylabel('f0 (cents)', 'FontSize', 18, 'FontWeight', 'bold')
